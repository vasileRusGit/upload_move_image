...
$content = '<div class="row-fluid">
        <div class="span4"><img src="Images/coffee1.png" class="imgLeft" /></div>
        <div class="span8"><h3>Title 1</h3>
        ...
        <div class="row-fluid">
        <div class="span4"> <img src="Images/coffee2.png" class="imgRight" /></div>
        <div class="span8"> <h3>Title 2</h3>
        <p style="font-size: 16px;">
         ...
         <div class="row-fluid">
         <div class="span4"><img src="Images/coffee3.png" class="imgLeft" /></div>
         <div class="span8"><h3>Title 3</h3>
         <p style="font-size: 16px;">
